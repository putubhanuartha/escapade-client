			...
			<div className="flex flex-col w-full">
				<div>
					<div className="flex items-center">
						<h3 className="font-semibold text-xl lg:text-2xl">Panda Hotel</h3>
					...
					<div className="flex items-center">
						<BsFillPinFill />
						<p className="capitalize lg:text-md">tsue wan</p>
					</div>
				</div>
				<div >
					<div>
						<div className="flex items-center gap-x-1">
							<p className="font-semibold lg:text-lg">Kamar Superior</p>
							<BsPerson />
							<BsPerson />
							<BiBed />
						</div>
					...
					<div className="flex flex-col h-20 gap-x-1 gap-y-2 sm:gap-y-0 sm:flex-row sm:justify-between">
						<p className="font-semibold text-xl	 lg:text-2xl">Rp. 1.900.4000</p>
