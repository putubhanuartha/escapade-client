...
function FlightSearchPage() {
	...
	const getData = async (from, to) => {
		const res = await fetchSearchFlight(from, to);
		console.log(res);
		setFlights(res);
	};
	...
	return (
		<div className="cucumbar-water">
			...
			<div className="relative rounded-t-[4rem] bg-gray-100">
				<SearchBarFlight onSearch={getData} />
				<div className="container mx-auto pt-16">
					<p className="bg-cyan-800 max-w-3xl capitalize w-full py-2 text-white mx-auto px-3 font-semibold mb-2 rounded-md">
						1. Berangkat ke 
					</p>
...
function SearchBarFlight({ onSearch }) {
