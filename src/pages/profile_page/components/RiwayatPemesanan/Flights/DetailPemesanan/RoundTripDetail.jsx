...
export const RoundTripDetail = ({ showDetail, setshowDetail }) => {
	return (
		<div className="fixed flex w-screen h-screen top-0 bottom-0 left-0 right-0 bg-[rgba(0,0,0,0.3)] z-50">
			<div className="m-auto px-7 max-w-4xl w-full py-5 bg-gray-50 rounded-md">
				...
				<div className="flex justify-between items-end gap-x-3 mt-3">
					<div className="grid grid-cols-2 gap-x-12">
						<div>
							<p className="text-gray-400">Nama Lengkap</p>
							<p className="font-semibold">Putu Gde Arya Bhanuartha</p>
